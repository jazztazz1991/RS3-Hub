...
def scrape_thieving_p2p():
    url = "https://runescape.wiki/w/Thieving_training"
    methods = []
    ...
    try:
        ...
        # Structure on wiki can vary. Look for headers followed by content.
        # Thieving training usually has "Levels X-Y"
        ...
        for header in headers:
            ...
            # Regex for Level ranges e.g. "Levels 1-5" or "Level 62+"
        ...
        print(f"Error scraping Thieving P2P: {e}")

    # Output path
    # .../scripts/guides/thieving/scrape.py
    current_dir = os.path.dirname(os.path.abspath(__file__))
    # Go up 3 levels to project root
    root_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(current_dir))))
    
    output_dir = os.path.join(root_dir, 'client', 'src', 'data', 'guides', 'thieving')
    output_path = os.path.join(output_dir, 'thievingP2P.json')
