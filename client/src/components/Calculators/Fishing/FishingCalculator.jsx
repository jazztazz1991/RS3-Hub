...
const FishingCalculator = () => {
    ...
    const [selectedItemId, setSelectedItemId] = useState('trout');
    ...
    const selectedItem = FISHING_ITEMS.find(i => i.id === selectedItemId) || FISHING_ITEMS[0];

    // Filter Logic
    const categories = ['All', ...new Set(FISHING_ITEMS.map(i => i.category))];
    const filteredItems = filterCategory === 'All' 
        ? FISHING_ITEMS 
        : FISHING_ITEMS.filter(i => i.category === filterCategory);
    ...
    return (
        <div className="fishing-calculator-container">
                    ...
                    <div className="input-group">
                     ...
                     <div className="selection-grids">
                        <div className="grid-column">
                            <h4 className="grid-label">Fish Type</h4>
