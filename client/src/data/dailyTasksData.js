export const DAILY_TASKS = [
    ...
    { id: 'caches', name: 'Guthixian Cache', category: 'Daily', description: 'Divination D&D (every 3 hours).' },
    { id: 'sinkholes', name: 'Sinkholes', category: 'Daily', description: 'Dungeoneering D&D (every hour).' },
